...
<body class="overflow-x-hidden antialiased">
    <!-- Header Section -->
    <header class="sticky top-0 z-50 relative z-50 w-full h-24 bg-white">
        <div
            class="container flex items-center justify-center h-full max-w-6xl px-8 mx-auto sm:justify-between xl:px-0">

            <a href="{{ route('home') }}" class="relative flex items-center inline-block h-5 h-full font-black leading-none">
                ...
                <span class="ml-3 text-xl text-gray-800">Bishop Amoo<span class="text-pink-500">.</span></span>
            </a>
            ...
            <nav id="nav"
                ...
                <a href="{{ route('addproduct') }}"
                    class="mr-0 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-indigo-600">Add Books</a>
                <a href="{{ route('books') }}"
                    class="font-bold duration-100 transition-color hover:text-indigo-600">Books</a>
                <div class="flex flex-col block w-full font-medium border-t border-gray-200 md:hidden">
                    @if(auth()->user())
                    <form action="{{ route('logout') }}" method="post">
                        @csrf
                        <button type="submit" class="relative z-40 inline-block w-auto h-full px-5 py-3 text-sm font-bold leading-none text-white transition-all transition duration-100 duration-300 bg-red-700 rounded shadow-md fold-bold lg:bg-red lg:text-white sm:w-full lg:shadow-none hover:shadow-xl">Logout</button>
                    </form>
                    @else
                    <a href="{{ route('login') }}" class="w-full py-2 font-bold text-center text-pink-500">Login</a>
                    <a href="/register" class="relative inline-block w-full px-5 py-3 text-sm leading-none text-center text-white bg-indigo-700 fold-bold">
                        Register</a>
                    @endif
                </div>
            </nav>
            ...
            <div
                ...
                @auth
                <button class="relative z-40 inline-block w-auto h-full px-5 py-3 text-sm font-bold leading-none text-white fold-bold">{{ auth()->user()->name }}</button>
                <form action="{{ route('logout') }}" method="post">
                    @csrf
                    <button type="submit" class="relative z-40 inline-block w-auto h-full px-5 py-3 text-sm font-bold leading-none text-white transition-all transition duration-100 duration-300 bg-red-700 rounded shadow-md fold-bold lg:bg-red lg:text-white sm:w-full lg:shadow-none hover:shadow-xl">Logout</button>
                </form>
